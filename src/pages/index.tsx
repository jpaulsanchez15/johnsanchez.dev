...
const projects: Project[] = [
  // TODO: Change these to be real projects
  {
    ...
    description: "Led the development of an internal application that revolutionized order processing, resulting in a remarkable 70% increase in efficiency and a 40% improvement in delinquent payment recovery. By automating tasks and reducing manual data entry by 90%, equivalent to the work of 3 employees, significant cost savings were achieved."
  },
  {
    title: "Sales Growth Display",
    href: "https://github.com/jpaulsanchez15/sales-display-public",
    description: "Designed and implemented a dynamic sales trends display showcased on TV, effectively presenting real-time sales data to stakeholders, potential investors, partners, and clients"
  },
  {
      ...
      <main>
        ...
        <section className="flex flex-col items-center my-12 m-auto justify-between">
          {projects.map((project) => (
            <Cards key={project.title} description={project.description} title={project.title} href={project.title} />
          ))}
